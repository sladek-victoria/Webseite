...
window.T.pl = {
  ...
  'chap-parking-title': 'Parkowanie', 'chap-checkin-title': 'Zameldowanie (dostęp)', 'chap-wlan-title': 'Wi-Fi', 'chap-infos-title': 'Zasady domu', 'chap-abreise-title': 'Wymeldowanie',
    'ch-park-1': 'Parkowanie', 'ch-park-2': 'Twoje miejsce parkingowe', 'ch-park-3': 'Proszę parkować na zielono oznaczonym miejscu parkingowym. Miejsce parkingowe jest oznaczone tabliczką "Prywatne".', 'ch-park-4': 'Miejsce parkingowe z oznaczeniem',
  ...
  'contact-sub': 'Można się z nami skontaktować telefonicznie w ciągu dnia.<br>Można też napisać do nas wiadomość WhatsApp.'
};
