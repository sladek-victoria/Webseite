...
window.T.fr = {
  ...
  'chap-parking-title': 'Parking', 'chap-checkin-title': 'Arrivée (accès)', 'chap-wlan-title': 'Wi-Fi', 'chap-infos-title': 'Règles de la maison', 'chap-abreise-title': 'Départ',
    'ch-park-1': 'Parking', 'ch-park-2': 'Votre place de parking', 'ch-park-3': 'Veuillez vous garer sur la place marquée en vert. La place est signalée par un panneau "Privé".', 'ch-park-4': 'Place de parking avec marquage',
  ...
  'contact-sub': 'Vous pouvez nous joindre par téléphone en journée.<br>Vous pouvez aussi nous envoyer un message WhatsApp.'
};
